const MicroModal = (() => {
   ...
   class Modal {
      constructor({
         ...
         this.config = { debugMode, singleActive, disableScroll, openTrigger, closeTrigger, openClass, onShow, onClose, onBeforeShow, onBeforeClose, awaitCloseAnimation, awaitOpenAnimation, disableFocus }
